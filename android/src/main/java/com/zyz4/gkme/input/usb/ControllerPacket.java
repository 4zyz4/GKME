...
/** Button flags used by the Axixi2233 USB driver, matching the Sunshine/Limelight layout. */
public class ControllerPacket {
    ...
    public static final int TOUCHPAD_FLAG = 0x100000;
    public static final int MISC_FLAG = 0x200000;
